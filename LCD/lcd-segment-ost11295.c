...
//===========================================================================
//FUNCTION NAME:    lcd_display_10digit_id
//PROTOTYPE:        void lcd_display_10digit_id(unsigned char value, char status)
//INPUT:            value: 2 chu so bieu gia, status: SHOW/ HIDE (blinking)
//OUTPUT:
//DESCRIPTION:      hien thi chu cac gia tri tai chu 'T' tren LCD(vi tri so 9 va 16)
//NOTE:
//============================================================================
void lcd_display_10digit_id(unsigned char value, char status)
{
    if (status == SHOW)
    {
        if (value == 0) //Hien thi dau gach ngang
        {
          lcd_display_digit(DISPLAY_DASH,16);
          lcd_display_digit(DISPLAY_DASH,9);
        }
        else
        {
            lcd_display_digit(value%10, 16);
...
{
    if (display.item == DISPLAY_ITEM_METER_ID) //Dang hien thi ID thi k co Er
    {
...
void lcd_display_alphabet(unsigned char value,unsigned char  pos)
{
    ...
    switch (value)
    {
        case 'A': value = A_CHAR; break;
        case 'B': value = B_CHAR; break;
        case 'C': value = C_CHAR; break;
        case 'E': value = E_CHAR; break;
        case 'H': value = H_CHAR; break;
        case 'I': value = I_CHAR; break;
        case 'N': value = N_CHAR; break;
        case 'L': value = L_CHAR; break;
        case 'O': value = O_CHAR; break;
        case 'P': value = P_CHAR; break;
        case 'R': value = R_CHAR; break;
        case 'V': value = V_CHAR; break;
        case 'Y': value = Y_CHAR; break;
        case 'r': value = r_CHAR; break;
        case 't': value = t_CHAR; break;
        case '-': value = DASH_CHAR; break;        
    }
