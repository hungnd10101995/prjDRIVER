...
// File :
//************************************************************************************************//
#ifndef _LCD_M0752_H_
#define _LCD_M0752_H_
//================================================================================================//
//		History
//================================================================================================//
...
extern void lcd_over_current(char status); //hien thi qua dong
extern void lcd_over_vol(char status); //hien thi qua ap
extern void lcd_low_vol(char status);
